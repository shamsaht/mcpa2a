# =============================================================================
# agents/px4_summarizer_agent/task_manager.py
# =============================================================================
# 🎯 Purpose:
# This file connects your Gemini-powered agent (PX4SummarizerAgent) to the task-handling system.
# It inherits from InMemoryTaskManager to:
# - Receive a task from the user
# - Extract the question (like "Explain offboard mode")
...
# 🤖 Import the actual agent we're using (Gemini-powered PX4SummarizerAgent)
...
# INFO:agents.px4_summarizer_agent.task_manager:Processing new task: 12345
...
class AgentTaskManager(InMemoryTaskManager):
    """
    🧠 This class connects the PX4SummarizerAgent to the task system.

    - It inherits all the logic from InMemoryTaskManager
    - It overrides the part where we handle a new task (on_send_task)
    - It uses the PX4SummarizerAgent to generate a response
    """

    def __init__(self, agent: PX4SummarizerAgent):
        super().__init__()     # Call parent class constructor
        self.agent = agent     # Store the PX4SummarizerAgent as a property
    ...
    def _get_user_query(self, request: SendTaskRequest) -> str:
        ...
        Example: If the user says "How does PX4 mixer work?", we pull that string out.
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        ...
        2. Ask the PX4SummarizerAgent for a reply
        ...
        # Step 3: Ask the PX4SummarizerAgent to respond
