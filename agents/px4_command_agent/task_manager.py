# =============================================================================
# agents/px4_command_agent/task_manager.py
# =============================================================================
# 🎯 Purpose:
# This file connects your Gemini-powered agent (PX4CommandAgent) to the task-handling system.
# It inherits from InMemoryTaskManager to:
# - Receive a task from the user
# - Extract the command request (like "Disarm the drone")
...
# 🤖 Import the actual agent we're using (Gemini-powered PX4CommandAgent)
...
# INFO:agents.px4_command_agent.task_manager:Processing new task: 12345
...
class AgentTaskManager(InMemoryTaskManager):
    """
    🧠 This class connects the PX4CommandAgent to the task system.

    - It inherits all the logic from InMemoryTaskManager
    - It overrides the part where we handle a new task (on_send_task)
    - It uses the PX4CommandAgent to generate a response
    """

    def __init__(self, agent: PX4CommandAgent):
        super().__init__()     # Call parent class constructor
        self.agent = agent     # Store the PX4CommandAgent as a property
    ...
    def _get_user_query(self, request: SendTaskRequest) -> str:
        ...
        Example: If the user says "Switch to offboard mode", we pull that string out.
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        ...
        2. Ask the PX4CommandAgent for a reply
        ...
        # Step 3: Ask the PX4CommandAgent to respond
